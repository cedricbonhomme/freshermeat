...
association_table_language = db.Table(
    "association_projects_langages",
    db.metadata,
    db.Column("project_id", db.Integer, db.ForeignKey("project.id")),
    db.Column("language_id", db.Integer, db.ForeignKey("language.id")),
)

association_table_project = db.Table(
...
class Project(db.Model):
    ...
    # relationships
    code_locations = db.relationship(
        "Code", backref="project", lazy="dynamic", cascade="all,delete-orphan"
    )
    ...
    licenses = db.relationship(
        "License", secondary=lambda: association_table_license, backref="projects"
    )
    languages = db.relationship(
        "Language", secondary=lambda: association_table_language, backref="projects"
    )
    ...
    cves = db.relationship(
        "CVE", backref="project", lazy="dynamic", cascade="all,delete-orphan"
    )
    ...
    news = db.relationship(
        "News", backref="project", lazy="dynamic", cascade="all,delete-orphan"
    )
